...
show_help() {
    ...
    *)
        ...
        help_info=(
            ...
            "   qr [name]                                       二维码信息"
            "   url [name]                                      URL 信息"
            "   mihomo, clash [name]                            输出 Mihomo/Clash YAML 订阅"
            "   refresh-sub [domain]                            刷新 Mihomo 订阅文件并配置 HTTP 入口"
            "   sub-url [domain]                                显示 Mihomo HTTP 订阅地址"
            "   log                                             查看日志"
            "   logerr                                          查看错误日志\n"
            "更改:"
            ...
            "   fix-nginxfile                                   修复 Nginx 配置文件"
            "   fix-config.json                                 修复 config.json\n"
            "管理:"
            "   un, uninstall                                   卸载"
            "   u, update [core | sh | dat | caddy | nginx] [ver]       更新"
            "   U, update.sh                                    更新脚本"
            "   s, status                                       运行状态"
            "   start, stop, restart [caddy | nginx]            启动，停止，重启"
            "   t, test                                         测试运行"
            "   reinstall                                       重装脚本\n"
            "测试:"
