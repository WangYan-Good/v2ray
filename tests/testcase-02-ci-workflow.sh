...
assert_not_contains ".github/workflows/ci.yml" 'skipped|too large for CI ShellCheck' "CI does not skip core.sh ShellCheck"
assert_contains ".github/workflows/ci.yml" 'bash -n' "CI runs bash syntax validation"
assert_contains "tests/shellcheck.sh" 'run_core_shellcheck' "ShellCheck helper checks core.sh"
assert_contains "tests/shellcheck.sh" 'function chunks' "core.sh is checked in chunks"
