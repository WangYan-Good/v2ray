...
| TC-03 | 第三个协议继续追加 | ✅ 通过 | 2026-04-11 | .add 新增 location 块 |
| TC-04 | 不同协议类型共存 | ✅ 通过 | 2026-04-11 | gRPC + 2x XHTTP 共存 |
| TC-05 | Nginx 包含所有 location | ✅ 通过 | 2026-04-11 | .conf + .add 合计包含 |
| TC-06 | Nginx 配置测试通过 | ✅ 通过 | 2026-04-11 | syntax ok, test successful |
| TC-07 | 删除协议不影响其他 | ✅ 通过 | 2026-04-11 | .add 保留空注释，.conf 未动 |
| TC-08 | 删除最后协议清理 | ✅ 通过 | 2026-04-11 | .add 保留 "# 伪装网站配置" |
| TC-13 | 单域名单协议不受影响 | ✅ 通过 | 2026-04-11 | gRPC 配置正常工作 |

### 全量回归测试结果 (TC-1 ~ TC-10 + TC-19 + TC-21)

| 阶段 | 通过 | 失败 | 通过率 |
|------|------|------|--------|
| TC-1 REALITY | 2/2 | 0 | 100% |
| TC-2 XHTTP | 1/1 | 0 | 100% |
| TC-3 命名统一 | 2/2 | 0 | 100% |
| TC-4 SHA256 | 2/2 | 0 | 100% |
| TC-5 SSL | 2/2 | 0 | 100% |
| TC-7 竞态修复 | 2/2 | 0 | 100% |
| TC-8 错误处理 | 3/3 | 0 | 100% |
| TC-9 文档链接 | 2/2 | 0 | 100% |
| TC-10 Shell 引用 | 2/2 | 0 | 100% |
| TC-19 CI/CD | 3/3 | 0 | 100% |
| TC-21 多协议共存 | 4/4 | 0 | 100% |
| **总计** | **25/25** | **0** | **100%** |

---

*文档创建: 2026-04-11 | 最后更新: 2026-04-11 | 状态: ✅ 全部通过 | 25/25 回归测试通过*
