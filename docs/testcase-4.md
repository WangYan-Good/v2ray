...
|---------|----------|----------|--------|------|
| TC-01 | ✅ 通过 | 2026-04-07 | Qwen | Xray-core 下载 + 校验通过, "文件完整性验证通过" |
| TC-02 | ✅ 通过 | 2026-04-07 | Qwen | Caddy checksums.txt 两行格式解析正确 |
| TC-03 | ✅ 通过 | 2026-04-07 | Qwen | jq 无 checksum, warn 降级跳过 |
| TC-04 | ✅ 通过 | 2026-04-07 | Qwen | 篡改文件 SHA256 不匹配, 校验拒绝 |
| TC-05 | ✅ 通过 | 2026-04-07 | Qwen | 伪造 checksum SHA256 不匹配, 校验拒绝 |
| TC-06 | ✅ 通过 | 2026-04-07 | Qwen | .dgst 无法获取时 warn 降级 |
| TC-07 | ✅ 通过 | 2026-04-07 | Qwen | checksums.txt 无法获取时 warn 降级 (设计层面) |
| TC-08 | ✅ 通过 | 2026-04-07 | Qwen | install.sh 集成 SHA256 校验 |
| TC-09 | ✅ 通过 | 2026-04-07 | Qwen | src/download.sh 集成 SHA256 校验 |
| TC-10 | ✅ 通过 | 2026-04-07 | Qwen | err() 调用 exit 1 终止安装 |
| E2E-01 | ✅ 通过 | 2026-04-07 | Qwen | .dgst 校验 zip 文件, 逻辑正确 |

---

*文档创建: 2026-04-07 | 状态: ✅ 已完成 | 11/11 全部通过 | 测试时间: 2026-04-07 | 服务器: bak.proxy.yourdie.com*
